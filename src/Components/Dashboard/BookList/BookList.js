...
const BookList = () => {
    ...
    useEffect(() => {
        axios.get('https://moto-repair-server.herokuapp.com/orderedByEmail?email='+loggedInUser.email)
            .then(res => {
                setOrders(res.data);
            })
    ...
    const handleDeleteService = (id) =>{
        ...
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://moto-repair-server.herokuapp.com/cancel-order/${id}`)
                    .then(res => {
